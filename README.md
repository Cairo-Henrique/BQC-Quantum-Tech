...
Os materiais aqui reunidos seguem o conteúdo oficial do curso, cobrindo desde os **fundamentos matemáticos e físicos** até **algoritmos quânticos, otimização e machine learning quântico**.
...
* Apoiar estudantes e entusiastas de computação quântica com uma base **teórica e prática**
...
* Algoritmos Clássicos (visão comparativa)
* Otimização Quântica
* Técnicas híbridas clássico–quânticas
* Prática em problemas de otimização
...
* Prática com redes neurais
* Aprendizagem de Máquina Quântica (QML)
* Modelos de aprendizado quântico
